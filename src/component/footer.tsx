...
{/*     <div className="flex text-base justify-center items-center gap-x-1 mt-10">
    ...
    <div className='flex justify-center items-center'>
      <span className='flex items-center gap-x-1'><FaDiscord size={14}/> Sherlock7#4380 |  <FaEnvelope  size={14}/> pegaxystellar@gmail.com </span>

    </div>
    <div className='flex justify-center items-center'>
      <span className='flex items-center justify-end'>If you like the project and want to donate : 0xF064d0C68Bf11E390B1Dc17037f135356D045590</span>
