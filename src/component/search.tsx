...
/*     
    ...
    return (
        <div className="flex items-center justify-center mt-10">
            <StyledInput loading={false}  iconPosition="left" className="w-5/12"  placeholder="Type your wallet address here..." onChange={(event : any) => setTextInput(event?.target?.value || '')}>
